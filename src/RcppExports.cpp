...
// weighting_function
NumericVector weighting_function(NumericVector x, double wf_mean, double wf_sd, double wf_exponent);
RcppExport SEXP _wsre_weighting_function(SEXP xSEXP, SEXP wf_meanSEXP, SEXP wf_sdSEXP, SEXP wf_exponentSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(weighting_function(x, wf_mean, wf_sd, wf_exponent));
...
NumericVector weight_gauss_kde_bhatt(NumericVector x, NumericVector weighted_samples, double wf_mean, double wf_sd, double wf_exponent, double bandwidth);
RcppExport SEXP _wsre_weight_gauss_kde_bhatt(SEXP xSEXP, SEXP weighted_samplesSEXP, SEXP wf_meanSEXP, SEXP wf_sdSEXP, SEXP wf_exponentSEXP, SEXP bandwidthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type wf_exponent(wf_exponentSEXP);
    Rcpp::traits::input_parameter< double >::type bandwidth(bandwidthSEXP);
    rcpp_result_gen = Rcpp::wrap(weight_gauss_kde_bhatt(x, weighted_samples, wf_mean, wf_sd, wf_exponent, bandwidth));
    return rcpp_result_gen;
END_RCPP
}
